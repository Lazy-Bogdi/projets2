 ...
 */
class getFosUser_Command_DeactivateUserService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['fos_user.command.deactivate_user'] = $instance = new \FOS\UserBundle\Command\DeactivateUserCommand(($container->privates['fos_user.util.user_manipulator'] ?? $container->load('getFosUser_Util_UserManipulatorService')));
