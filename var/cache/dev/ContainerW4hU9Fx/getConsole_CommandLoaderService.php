...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'fos_user.command.activate_user' => ['privates', '.fos_user.command.activate_user.lazy', 'get_FosUser_Command_ActivateUser_LazyService', true],
            'fos_user.command.change_password' => ['privates', '.fos_user.command.change_password.lazy', 'get_FosUser_Command_ChangePassword_LazyService', true],
            'fos_user.command.create_user' => ['privates', '.fos_user.command.create_user.lazy', 'get_FosUser_Command_CreateUser_LazyService', true],
            'fos_user.command.deactivate_user' => ['privates', '.fos_user.command.deactivate_user.lazy', 'get_FosUser_Command_DeactivateUser_LazyService', true],
            'fos_user.command.demote_user' => ['privates', '.fos_user.command.demote_user.lazy', 'get_FosUser_Command_DemoteUser_LazyService', true],
            'fos_user.command.promote_user' => ['privates', '.fos_user.command.promote_user.lazy', 'get_FosUser_Command_PromoteUser_LazyService', true],
