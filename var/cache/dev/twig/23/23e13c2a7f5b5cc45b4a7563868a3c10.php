...
class __TwigTemplate_dc4e852667020bbea2fc5a1af53c61b7 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_comment_delete', {'id': comment.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ comment.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "comment/_delete_form.html.twig", "C:\\Users\\Lemme\\NWS\\Tuto\\S2\\ProjetS2\\templates\\comment\\_delete_form.html.twig");
    }
}
